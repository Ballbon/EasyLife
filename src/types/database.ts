    ...
    Tables: {
      ...
      plan_allocations: {
        Row: {
          ...
          planned_amount_satang: number | null
          updated_at: string
          user_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "allocations_category_owner_fk"
            columns: ["category_id", "user_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id", "user_id"]
          ...
          {
            foreignKeyName: "allocations_plan_owner_fk"
            columns: ["financial_plan_id", "user_id"]
            isOneToOne: false
      ...
      task_completions: {
        ...
        Relationships: [
          {
            foreignKeyName: "completions_task_owner_fk"
      ...
      task_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedules_task_owner_fk"
            columns: ["task_id", "user_id"]
            isOneToOne: false
            referencedRelation: "tasks"
            referencedColumns: ["id", "user_id"]
